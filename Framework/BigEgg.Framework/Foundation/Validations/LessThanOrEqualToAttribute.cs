...
namespace BigEgg.Framework.Foundation.Validations
{
    ...
    public class LessThanOrEqualToAttribute : IsAttribute
    {
        ...
        public LessThanOrEqualToAttribute(object dependentObject, ValidationType validationType = ValidationType.ByValue)
            : base(dependentObject, validationType, Operator.LessThanOrEqualTo)
        {
        }
    }
}
