...
namespace BigEgg.Framework.Foundation.Validations
{
    ...
    public class NotEqualToAttribute : IsAttribute
    {
        ...
        public NotEqualToAttribute(object dependentObject, ValidationType validationType = ValidationType.ByValue)
            : base(dependentObject, validationType, Operator.NotEqualTo)
        {
        }
    }
}
